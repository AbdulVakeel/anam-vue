<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4 py-6 sm:py-8">
    <div class="w-full max-w-md bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-lg p-6 sm:p-8 md:p-10">
      
      <!-- Header -->
      <div class="text-center mb-6">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100">Create Account</h1>
        <p class="text-sm sm:text-base text-gray-500 dark:text-gray-400 mt-2">Get started in seconds</p>
      </div>
      ...
      <form @submit.prevent="submit" class="space-y-4 sm:space-y-5">
        ...
        <AppButton block type="submit" class="mt-3">Create Account</AppButton>
      </form>

      <!-- Footer -->
      <p class="mt-5 text-xs sm:text-sm text-center text-gray-600 dark:text-gray-400">
